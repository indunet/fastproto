 ...
 *
 * <p>Since version 3.13.0, this class first attempts to look up pre-compiled formulas from
 * the {@link FormulaRegistry} generated by the annotation processor. If not found, it falls
 * back to dynamic compilation (which is disabled by default for Android/JRE compatibility).
 *
 * @author Deng Ran
 * @since 3.5.0
 */
public class FormulaFlow extends ResolvePipeline {
    ...
    private void setDecodingFormula(Reference reference, DecodingFormula formula) {
        if (formula.value().length != 0) {
            ...
            // First, try to get pre-compiled formula from registry (generated by annotation processor)
            ...
            // Fallback to dynamic compilation (disabled by default)
