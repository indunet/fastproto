...
public class UInt16CodecTest {
    ...
    public void testDecode() {
        ...
        assertThrows(DecodingException.class, () -> this.codec.decode(mock(-11, ByteOrder.LITTLE), new ByteBufferInputStream(bytes)));
    ...
    public void testEncode() {
        ...
        assertThrows(NullPointerException.class,
                () -> this.codec.encode(mock(0, ByteOrder.LITTLE), (ByteBufferOutputStream) null, 8));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(10, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), 1));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(10, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), Integer.MAX_VALUE));
    }
