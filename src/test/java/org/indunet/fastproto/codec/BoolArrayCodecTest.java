...
public class BoolArrayCodecTest {
    ...
    public void testDecode1() {
        ...
        boolean[] actual = codec.decode(datas, 0, 0, 8, BoolArrayType.MSB_0);
    ...
    public void testEncode1() {
        ...
        codec.encode(actual, 0, 0, BoolArrayType.MSB_0, datas);
        assertArrayEquals(expected, actual);
    }
    ...
    public void testEncode2() {
        ...
        codec.encode(actual, 0, 3, BoolArrayType.MSB_0, new boolean[] { true, false, true, false, true });
        assertArrayEquals(new byte[] { (byte) 0b0001_0101, (byte) 0b0000_0000 }, actual);

        actual = new byte[2];
        codec.encode(actual, 1, 0, BoolArrayType.MSB_0, new boolean[] { true });
        assertArrayEquals(new byte[] { (byte) 0b0000_0000, (byte) 0b1000_0000 }, actual);

        actual = new byte[2];
        codec.encode(actual, 1, 7, BoolArrayType.LSB_0, new boolean[] { true });
        assertArrayEquals(new byte[] { (byte) 0b0000_0000, (byte) 0b1000_0000 }, actual);
    }
}
