...
public class ShortArrayCodecTest {
    ...
    public void testEncode2() {
        ...
        assertThrows(NullPointerException.class, () -> this.codec.encode(null, 0, -1, ByteOrder.LITTLE, new short[8]));
        assertThrows(NullPointerException.class, () -> this.codec.encode(datagram, 0, -1, ByteOrder.LITTLE, null));

        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, -2, -7, ByteOrder.LITTLE, new short[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, -11, -7, ByteOrder.LITTLE, new short[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, 10, -1, ByteOrder.LITTLE, new short[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, 0, 11, ByteOrder.LITTLE, new short[8]));
    }
}
