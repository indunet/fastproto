...
public class UInt32CodecTest {
    ...
    public void testDecode() {
        ...
        assertThrows(DecodingException.class, () -> this.codec.decode(mock(8, ByteOrder.LITTLE), new ByteBufferInputStream(bytes)));
    }
    ...
    public void testEncode() {
        ...
        assertThrows(NullPointerException.class,
                () -> this.codec.encode(mock(0, ByteOrder.LITTLE), (ByteBufferOutputStream) null, 8L));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(10, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), 1L));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(0, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), Long.MAX_VALUE));
    }
