...
public class FloatArrayCodecTest {
    ...
    public void testEncode2() {
        ...
        assertThrows(NullPointerException.class, () -> this.codec.encode(null, 0, -1, EndianPolicy.LITTLE, new float[8]));
        assertThrows(NullPointerException.class, () -> this.codec.encode(datagram, 0, -1, EndianPolicy.LITTLE, null));

        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, -2, -7, EndianPolicy.LITTLE, new float[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, -11, -7, EndianPolicy.LITTLE, new float[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, 10, -1, EndianPolicy.LITTLE, new float[8]));
        assertThrows(EncodingException.class, () -> this.codec.encode(datagram, 0, 11, EndianPolicy.LITTLE, new float[8]));
    }
}
