...
public class DoubleCodecTest {
    ...
    public void testDecode() {
        ...
        assertThrows(NullPointerException.class,
                () -> this.codec.decode(mock(10, ByteOrder.LITTLE), (ByteBufferInputStream) null));

        assertThrows(DecodingException.class,
                () -> this.codec.decode(mock(-1, ByteOrder.LITTLE), new ByteBufferInputStream(bytes)));
        assertThrows(DecodingException.class,
                () -> this.codec.decode(mock(8, ByteOrder.LITTLE), new ByteBufferInputStream(bytes)));
    }
    ...
    public void testEncode() {
        ...
        assertThrows(NullPointerException.class,
                () -> this.codec.encode(mock(0, ByteOrder.LITTLE), (ByteBufferOutputStream) null, 3.14));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(-1, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), 3.141));
        assertThrows(EncodingException.class,
                () -> this.codec.encode(mock(10, ByteOrder.LITTLE), new ByteBufferOutputStream(bytes), 3.141));
    }
