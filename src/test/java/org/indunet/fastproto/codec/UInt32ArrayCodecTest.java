...
public class UInt32ArrayCodecTest {
    ...
    public void testDecode1() {
        ...
        val bytes = BinaryUtils.uint32Of(expected, ByteOrder.LITTLE);
    ...
    public void testEncode1() {
        ...
        assertArrayEquals(bytes, BinaryUtils.uint32Of(values, ByteOrder.LITTLE));
    ...
    protected CodecContext mock(int offset, int length, ByteOrder order) {
        return CodecContext.builder()
                .dataTypeAnnotation(AnnotationUtils.mock(UInt32ArrayType.class, offset, length, order))
                .build();
    }
}
