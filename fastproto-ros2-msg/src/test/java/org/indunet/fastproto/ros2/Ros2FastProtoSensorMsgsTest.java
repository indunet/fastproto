...
class Ros2FastProtoSensorMsgsTest extends Ros2FastProtoTestSupport {
    ...
    void testImuRoundTrip() {
        ...
        byte[] bytes = imu.encode();
        assertEquals(328, bytes.length);
        assertEquals(imu, Imu.decode(bytes));
    }
    ...
    void testImageRoundTrip() {
        ...
        assertEquals(image, Image.decode(image.encode()));
    }
    ...
    void testCompressedImageRoundTrip() {
        ...
        assertEquals(image, CompressedImage.decode(image.encode()));
    }
    ...
    void testCameraInfoRoundTrip() {
        ...
        assertEquals(cameraInfo, CameraInfo.decode(cameraInfo.encode()));
    }
    ...
    void testMagneticFieldRoundTrip() {
        ...
        assertEquals(magneticField, MagneticField.decode(magneticField.encode()));
    }
    ...
    void testTemperatureRoundTrip() {
        ...
        assertEquals(temperature, Temperature.decode(temperature.encode()));
    }

    @Test
    void testFluidPressureRoundTrip() {
        ...
        assertEquals(fluidPressure, FluidPressure.decode(fluidPressure.encode()));
    }
    ...
    void testPointCloud2RoundTrip() {
        ...
        assertEquals(pointCloud2, PointCloud2.decode(pointCloud2.encode()));
    }
    ...
    void testPointCloudRoundTrip() {
        ...
        assertEquals(pointCloud, PointCloud.decode(pointCloud.encode()));
    }
    ...
    void testLaserScanRoundTrip() {
        ...
        assertEquals(laserScan, LaserScan.decode(laserScan.encode()));
    }
    ...
    void testMultiEchoLaserScanRoundTrip() {
        ...
        assertEquals(laserScan, MultiEchoLaserScan.decode(laserScan.encode()));
    }
    ...
    void testRangeRoundTrip() {
        ...
        assertEquals(range, Range.decode(range.encode()));
    }
    ...
    void testNavSatFixRoundTrip() {
        ...
        assertEquals(navSatFix, NavSatFix.decode(navSatFix.encode()));
    }

    @Test
    void testIlluminanceRoundTrip() {
        ...
        assertEquals(illuminance, Illuminance.decode(illuminance.encode()));
    }

    @Test
    void testRelativeHumidityRoundTrip() {
        ...
        assertEquals(relativeHumidity, RelativeHumidity.decode(relativeHumidity.encode()));
    }

    @Test
    void testJoyRoundTrip() {
        Joy joy = Joy.builder()
        ...
        assertEquals(joy, Joy.decode(joy.encode()));
    }
    ...
    void testJointStateRoundTrip() {
        ...
        assertEquals(jointState, JointState.decode(jointState.encode()));
    }
    ...
    void testJoyFeedbackArrayRoundTrip() {
        ...
        assertEquals(feedbackArray, JoyFeedbackArray.decode(feedbackArray.encode()));
    }
    ...
    void testBatteryStateRoundTrip() {
        ...
        assertEquals(batteryState, BatteryState.decode(batteryState.encode()));
    }
    ...
    void testTimeReferenceRoundTrip() {
        ...
        assertEquals(timeReference, TimeReference.decode(timeReference.encode()));
    }
}
